...
//  MemeMe1.0
//
//  Created by Rafif Kalantan on 01/06/2020.
...
UINavigationControllerDelegate, UITextFieldDelegate {
    ...
    func save(memedImage: UIImage) {
            // Create the meme
        _ = Meme(topText: topTextField.text! as NSString, bottomText: bottomTextField.text! as NSString, image: imagePickerView.image!, memedImage: memedImage)
    }
